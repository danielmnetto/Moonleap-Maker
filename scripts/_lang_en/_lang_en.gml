lang_add("EN", { 
  ...
  maker_help_welcome: "Welcome to Moonleap Maker!\n\nCreate custom levels using elements from Moonleap, challenge yourself and share them with your friends!",
  maker_help_creating_and_testing: "Building and testing your level\n\nSelect an object from the list above and place it on the screen in the center. Then press the Play button in the lower left corner to test your level.",
  maker_help_custom_config: "Changing level information\n\nTo configure information about your level, press the menu button on the left side of the screen and change options such as level name, author and perfect score.",
  maker_help_recommendations: "Recommendations\n\nMake sure only the Player loops in the level. Some elements may not work correctly if placed in certain positions in the level.",
  maker_help_layers: "Placing decoration tiles\n\nYou can decorate your level using decoration tiles. Press the layers button on the right side of the screen to switch between depths, select and start placing the desired tiles in the level.",
  maker_help_change_style1: "Changing the level style\n\nIf you want to change the level style, press the brush button on the right side of the screen until the desired option appears.",
  maker_help_change_style2: "About level styles and decoration tiles\n\nDecoration tiles are unique to each level style and you will need to delete them from the level when changing it. Therefore, first choose the level style and then start decorating.",
  maker_help_save_level: "Saving levels\n\nWhen you are satisfied with your level or wish to save it to continue later, press the floppy disk button on the left side of the screen and choose how you want to save your level.",
  maker_help_load_level: "Loading levels\n\nIf you want to load a level of yours or someone else's saved on your device, press the folder button on the left side of the screen and select a file whose name ends with .moonlevel",
  maker_help_shortcut_keyboard1: "Keyboard shortcuts\n\nWASD - Move the cursor\nQ and E - Simulate mouse clicks (left and right, respectively)\nArrow Keys - Navigate between menu elements",
  maker_help_shortcut_keyboard2: "Keyboard shortcuts\n\nZ - Rotate the selected element\nX - Mirror the selected element\nF5 - Toggle between testing the level and returning to the editor\nENTER or ESC - Open the menu",
  maker_help_shortcut_controller1: "Gamepad shortcuts\n\nAnalog Sticks - Move the cursor\nBumpers - Simulate mouse clicks (left and right, respectively)\nD-Pad - Navigate between menu elements",
  maker_help_shortcut_controller2: "Gamepad shortcuts\n\nLeft Face Button - Rotate the selected element\nTop Face Button - Mirror the selected element\nStart Button - Toggle between testing the level and returning to the editor\nSelect Button - Open the menu",
