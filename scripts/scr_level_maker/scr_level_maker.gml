...
function level_maker_get_objects_list() {
  ...
  // Page 1
	_obj[0, 00] =	new LMObject(oPlayer,	16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("is_unique", "is_player");
	_obj[0, 01] =	new LMObject(oSolid, 16, 16)
    .add_tag("grid_16", "is_holdable");
	_obj[0, 02] =	new LMObject(oBrokenStone, 16, 16)
    .add_tag("grid_16", "is_holdable");
	_obj[0, 03] =	new LMObject(oPlatGhost, 16, 16)
    .add_tag("can_spin");
	_obj[0, 04] =	new LMObject(oSolidRamp, 32, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip")
    .set_sprite_button_part(sBlockRampEditor, 0, 16, 0, -8, -8);
	_obj[0, 05] =	new LMObject(oPermaSpike,	16, 16)
    .add_tag("is_holdable");
	_obj[0, 06] =	new LMObject(oSolidDay, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.OFFSET5)
    .add_tag("grid_16", "is_holdable")
    .set_can_change(true);
	_obj[0, 07] =	new LMObject(oSolidNight, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.OFFSET5)
    .add_tag("grid_16", "is_holdable")
    .set_can_change(true)
	...
	_obj[0, 12] =	new LMObject(oSnail, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("can_flip")
    .set_sprite_button_part(sSnailWalk, 0, 0, 2, -9, 0)
    .set_can_change(true);
	_obj[0, 13] =	new LMObject(oSnailNight,	16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("can_flip")
    .set_sprite_button_part(sSnailIdleNight, 0, 0, 2, -11, 0, 18)
    .set_can_change(true)
    .set_is_moon_variant(true);
	_obj[0, 14] =	new LMObject(oLady, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip")
    .set_preview_index_horizontal(1);
	_obj[0, 15] =	new LMObject(oBat, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip", "grid_16")
    .set_sprite_button_part(sBat, 0, 10, 4, -7, -8);
	
  // Page 2
	_obj[1, 00] =	new LMObject(oPlayerDir, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("is_unique", "is_player");
	_obj[1, 01] =	new LMObject(oBigSolid, 32, 32)
    .add_tag("grid_16", "is_holdable")
    .set_sprite_button_part(sBlockGrayGiant, 0, 0, 0, 0, 0);
	_obj[1, 02] =	new LMObject(oBrokenStoneBig,	32, 32)
    .add_tag("grid_16", "is_holdable")
    .set_sprite_button_part(sBrokenStoneBig, 0, 0, 0, 0, 0);
	...
	_obj[1, 06] =	new LMObject(oMush,	16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("can_spin");
	_obj[1, 07] =	new LMObject(oMushGray, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("can_spin")
    .set_sprite_button_part(sMushGrayUI, 0, 0, 0, 0, 0);
	_obj[1, 08] =	new LMObject(oSnailGray, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("can_flip");
	_obj[1, 09] =	new LMObject(oLadyGray, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip")
    .set_sprite_button_part(sLadyGrayUI, 0, 3, 0, -8, -8);
	_obj[1, 10] =	new LMObject(oLadyVer, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip", "is_vertical")
    .set_preview_index_vertical(1)
    .set_sprite_button_part(sLadyVerUI, 0, 3, 1, -8, -8);
	_obj[1, 11] =	new LMObject(oLadyGiant, 48, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip")
    .set_preview_index_horizontal(1)
    .set_sprite_button_part(sLadyGiant, 0, 19, 1, -8, -8);
	_obj[1, 12] =	new LMObject(oLadyGiant4, 64, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip")
    .set_preview_index_horizontal(1)
    .set_sprite_button_part(sLadyGiant4, 0, 14, 1, -8, -8);
	_obj[1, 13] =	new LMObject(oBatVer, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip", "grid_16", "is_vertical")
    .set_preview_index_vertical(1)
    .set_sprite_button_part(sBatDown, 0, 10, 4, -7, -8);
	_obj[1, 14] =	new LMObject(oBatGiant,	48, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip")
    .set_sprite_button_part(sBatGiant, 0, 21, 1, -8, -8)
	_obj[1, 15] =	new LMObject(oBatSuperGiant, 64, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.CENTER)
    .add_tag("can_flip")
    .set_sprite_button_part(sBatGiant4, 0, 12, 1, -8, -8);
	
  // Page 3
	_obj[2, 00] =	new LMObject(oPlayerNeutral, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("is_unique", "is_player");
	_obj[2, 01] =	new LMObject(oBird, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("can_flip", "is_unique");
	_obj[2, 02] =	new LMObject(oKey, 16, 16);
	_obj[2, 03] =	new LMObject(oKeyDoor, 16, 16);
	_obj[2, 04] =	new LMObject(oKeyTall, 16, 32)
    .set_sprite_button_part(sKeyDoorTallUI, 0, 0, 8, -8, -8);
	_obj[2, 05] =	new LMObject(oKeyDoorTall, 16, 32)
    .set_sprite_button_part(sKeyDoorTall, 0, 0, 8, -8, -8);
	_obj[2, 06] =	new LMObject(oKeyWide, 32, 16)
    .set_sprite_button_part(sKeyDoorWideUI, 0, 8, 0, -8, -8);
	_obj[2, 07] =	new LMObject(oKeyDoorWide, 32, 16)
    .set_sprite_button_part(sKeyDoorWide, 0, 8, 0, -8, -8);
	_obj[2, 08] =	new LMObject(oKeyTallWide, 32, 32)
    .set_sprite_button_part(sKeyDoorTallWideUI, 0, 0, 0, -8, -8);
	_obj[2, 09] =	new LMObject(oKeyDoorTallWide, 32, 32)
    .set_sprite_button_part(sKeyDoorWideTall, 0, 0, 0, -8, -8);
	_obj[2, 10] =	new LMObject(oMagicOrb, 16, 16, LEVEL_MAKER_OBJECT_SPRITE_ORIGIN.BOTTOM)
    .add_tag("is_unique", "is_orb");
	_obj[2, 11] =	new LMObject(oStarFly, 16, 16);
	_obj[2, 12] =	new LMObject(oSolidInv, 16, 16)
    .add_tag("grid_16", "is_holdable");
